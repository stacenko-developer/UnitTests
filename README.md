...
2. [NSubstitute](#NSubstitute)
    ...
    2. [Проверка передачи аргументов через Any и Is](#Проверка-передачи-аргументов-через-Arg.Any-и-Arg.Is)
    3. [Условные действия через When => Do](#Условные-действия-через-Whe)-=>-Do)
...
____
### Проверка передачи аргументов через Arg.Any и Arg.Is
```C#
/// <summary>
